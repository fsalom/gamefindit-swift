...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titleAttributes = [NSAttributedString.Key.foregroundColor: UIColor(named: "CustomBlack") ?? .black, NSAttributedString.Key.font: UIFont(name: "SF Pro Display Bold", size: 15) ?? UIFont()]
